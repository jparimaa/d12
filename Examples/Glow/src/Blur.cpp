...
bool Blur::initialize(Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList>& commandList)
{
...
void Blur::createShaders()
{
    ...
    std::wstring BlurShaderPath = shaderPath;
    BlurShaderPath += L"singlePassBlur.hlsl";
    m_vertexShader = fw::compileShader(BlurShaderPath, nullptr, "VS", "vs_5_0");
    m_pixelShader = fw::compileShader(BlurShaderPath, nullptr, "PS", "ps_5_0");
}

void Blur::createRootSignature()
{
